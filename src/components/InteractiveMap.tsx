  ...
  useEffect(() => {
    ...
    nearbyActivities.forEach((activity, index) => {
      ...
      const scale = Math.max(
        0.3,
        Math.min(1, Math.sin(spawnTime * 2) * 0.5 + 0.5),
      );
      ...
      if (isSelected) {
        ...
        ctx.arc(
          pos.x,
          pos.y,
          markerSize + 6 + Math.sin(time * 3) * 2,
          0,
          Math.PI * 2,
        );
        ctx.stroke();
    ...
    ctx.fillText(
      `Visible: ${nearbyActivities.length}`,
      statsX + 10,
      statsY + 35,
    );
        ...
        >
          <button
            ...
            style={{
              ...
              fontWeight: "bold",
              boxShadow:
                "0 4px 12px rgba(0, 122, 255, 0.3), 0 0 20px rgba(0, 122, 255, 0.15)",
              transition: "all 0.2s",
              color: "#fff",
            }}
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow =
                "0 6px 16px rgba(0, 122, 255, 0.5), 0 0 30px rgba(0, 122, 255, 0.25)";
            }}
            onMouseLeave={(e) => {
      ...
      {selectedActivity && (
        ...
        >
            ...
            <div>
              ...
              <div
                style={{
                  ...
                  borderRadius: "20px",
                  backgroundColor:
                    CATEGORY_COLORS[selectedActivity.category] ||
          ...
          <div style={{ fontSize: "12px", color: "#666", lineHeight: "1.6" }}>
            <div>
              📅{" "}
              {(selectedActivity.date instanceof Date
